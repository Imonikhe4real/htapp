...
class MathematicsconfirmController extends Controller
{
    public function index()
    {
        return view('mathematicsconfirm');
    }
    public function store(Request $request)
    {
        ...
        DB::table('mathematics')->insert($sql);

        return redirect('mathematicsconfirm')->with(array(
             'fullname' => $fullname,
             'answer1' => $answer1,
             'answer2' => $answer2,
             'answer3' => $answer3,
