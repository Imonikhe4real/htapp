...
class ChemistryconfirmController extends Controller
{
    public function index()
    {
        return view('chemistryconfirm');
    }
    public function store(Request $request)
  {
      ...
      DB::table('chemistries')->insert($sql);
       
    return redirect('chemistryconfirm')->with(array(
        'fullname' => $fullname,
        'answer1' => $answer1,
        'answer2' => $answer2,
        'answer3' => $answer3,
