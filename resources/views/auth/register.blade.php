...
<div class="w3-row">
<div class="w3-half">
  <img src="/images/imgstd.jpg"  style="width:100%;height:720px;">
</div>
...
<center>
    <div class="w3-border w3-black w3-text-white" style="width:100%;height:30px;font-weight:bolder;
                ...
                <div class="w3-border-0  w3-yellow w3-text-black"  style="height:690px;width:100%;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div>
                            ...
                            <div>
                                <input id="firstname" type="text" class="w3-input w3-border @error('firstname') is-invalid @enderror" name="firstname" style="width:40%;" value="{{ old('firstname') }}" required="required" placeholder="Enter firstname here..." autocomplete="firstname" autofocus>
